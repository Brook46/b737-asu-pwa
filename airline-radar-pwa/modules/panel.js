...
import * as fmt from './fmt.js?v=18';
import { altColor, familyOf, planeSvg, classLine } from './aircraft.js?v=18';
import { routeLabel, progress, haversine, eta, routeSanity } from './routes.js?v=18';
import { squawkAlert } from './adsb.js?v=18';
