...
import * as fmt from './fmt.js?v=17';
import { altColor, familyOf, planeSvg, classLine } from './aircraft.js?v=17';
import { routeLabel, progress, haversine, eta, routeSanity } from './routes.js?v=17';
import { squawkAlert } from './adsb.js?v=17';
