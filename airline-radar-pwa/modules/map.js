...
import { altColor, planeSvg, sizeFor, sizeClass } from './aircraft.js?v=16';
import { alt as fmtAlt, ago as fmtAgo } from './fmt.js?v=16';
import * as runways from './runways.js?v=16';
