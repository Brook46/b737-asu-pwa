...
import { altColor, planeSvg, sizeFor, sizeClass } from './aircraft.js?v=13';
import { alt as fmtAlt, ago as fmtAgo } from './fmt.js?v=13';
import * as runways from './runways.js?v=13';
