...
check "airline-radar index"    "$BASE/airline-radar-pwa/"
check "airline-radar app.js"   "$BASE/airline-radar-pwa/app.js"
check "airline-radar sw.js"    "$BASE/airline-radar-pwa/sw.js"
check "airline-radar adsb.js"  "$BASE/airline-radar-pwa/modules/adsb.js"
check "airline-radar airlines.js" "$BASE/airline-radar-pwa/modules/airlines.js"
...
check "sky-club index"     "$BASE/sky-club-pwa/"
check "sky-club app.js"    "$BASE/sky-club-pwa/app.js"
check "sky-club sw.js"     "$BASE/sky-club-pwa/sw.js"
check "line-trim index"    "$BASE/line-trim-pwa/"
check "line-trim app.js"   "$BASE/line-trim-pwa/app.js"
check "line-trim sw.js"    "$BASE/line-trim-pwa/sw.js"
check "line-trim trim.js"  "$BASE/line-trim-pwa/modules/trim.js"
check "line-trim wings"    "$BASE/line-trim-pwa/data/wings/index.json"
check "sky-club astronomy-engine.js" "$BASE/sky-club-pwa/vendor/astronomy-engine.js"
check "sky-club orbits.js" "$BASE/sky-club-pwa/modules/orbits.js"
