...
const CACHE_VERSION = 'skyclub-v23';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=23',
  ...
  './manifest.json',
  './icon.svg',
  './modules/astro.js?v=23',
  './modules/catalog.js?v=23',
  './modules/orbits.js?v=23',
  './modules/sky.js?v=23',
  './modules/sensors.js?v=23',
  './modules/speech.js?v=23',
  './modules/starfield.js?v=23',
  './modules/moonphase.js?v=23',
  './modules/badges.js?v=23',
  './modules/events.js?v=23',
  './modules/resume.js?v=23',
  './modules/geomag.js?v=23',
  './modules/wmm2025.js?v=23',
  './modules/globe.js?v=23',
  './modules/sunfx.js?v=23',
  './modules/orrery3d.js?v=23',
  './modules/cardglobe.js?v=23',
