...
(function () {
  ...
  const MANIFEST = {
    ...
    'obstacle-pull-up': 'sounds/obstacle-pull-up.wav',
    'caution-obstacle': 'sounds/caution-obstacle.wav',
    'approaching-minimums': 'sounds/approaching-minimums.wav',
    'tcas-traffic': 'sounds/tcas-traffic.wav',
    'tcas-climb': 'sounds/tcas-climb.wav',
    'tcas-descend': 'sounds/tcas-descend.wav',
    'tcas-clear': 'sounds/tcas-clear.wav',
    'tcas-increase-climb': 'sounds/tcas-increase-climb.wav',
    'tcas-monitor-vs': 'sounds/tcas-monitor-vs.wav',
    'tcas-climb-now': 'sounds/tcas-climb-now.wav',
    'tcas-descend-now': 'sounds/tcas-descend-now.wav',
    'bullshit': 'sounds/bullshit.wav',
