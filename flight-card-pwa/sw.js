...
const CACHE_VERSION = 'flightcard-v129';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=129',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=129',
  './modules/dates.js?v=129',
  './modules/data-card.js?v=129',
  './modules/checklist.js?v=129',
  './modules/print.js?v=129',
  './modules/ui.js?v=129',
  './modules/ocr.js?v=129',
  './modules/speeches.js?v=129',
  './modules/airports.js?v=129',
  './modules/worldmap.js?v=129',
  './modules/roster.js?v=129',
  './modules/ly-routes.js?v=129',
  './modules/wx.js?v=129',
  './modules/logbook.js?v=129',
  './modules/logbook-push.js?v=129',
  './modules/gps.js?v=129',
  './modules/g.js?v=129',
  './modules/analytics.js?v=129',
  './modules/ical.js?v=129',
  './modules/calendar.js?v=129',
  './modules/proxy.js?v=129',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
