...
const CACHE_VERSION = 'flightcard-v114';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=114',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=114',
  './modules/dates.js?v=114',
  './modules/data-card.js?v=114',
  './modules/checklist.js?v=114',
  './modules/print.js?v=114',
  './modules/ui.js?v=114',
  './modules/ocr.js?v=114',
  './modules/speeches.js?v=114',
  './modules/airports.js?v=114',
  './modules/roster.js?v=114',
  './modules/ly-routes.js?v=114',
  './modules/wx.js?v=114',
  './modules/logbook.js?v=114',
  './modules/logbook-push.js?v=114',
  './modules/gps.js?v=114',
  './modules/g.js?v=114',
  './modules/analytics.js?v=114',
  './modules/ical.js?v=114',
  './modules/calendar.js?v=114',
  './modules/proxy.js?v=114',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
