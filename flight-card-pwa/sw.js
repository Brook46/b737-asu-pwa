...
const CACHE_VERSION = 'flightcard-v112';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=112',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=112',
  './modules/dates.js?v=112',
  './modules/data-card.js?v=112',
  './modules/checklist.js?v=112',
  './modules/print.js?v=112',
  './modules/ui.js?v=112',
  './modules/ocr.js?v=112',
  './modules/speeches.js?v=112',
  './modules/airports.js?v=112',
  './modules/roster.js?v=112',
  './modules/ly-routes.js?v=112',
  './modules/wx.js?v=112',
  './modules/logbook.js?v=112',
  './modules/logbook-push.js?v=112',
  './modules/gps.js?v=112',
  './modules/g.js?v=112',
  './modules/analytics.js?v=112',
  './modules/ical.js?v=112',
  './modules/calendar.js?v=112',
  './modules/proxy.js?v=112',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
