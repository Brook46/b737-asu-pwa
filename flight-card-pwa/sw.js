...
const CACHE_VERSION = 'flightcard-v128';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=128',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=128',
  './modules/dates.js?v=128',
  './modules/data-card.js?v=128',
  './modules/checklist.js?v=128',
  './modules/print.js?v=128',
  './modules/ui.js?v=128',
  './modules/ocr.js?v=128',
  './modules/speeches.js?v=128',
  './modules/airports.js?v=128',
  './modules/worldmap.js?v=128',
  './modules/roster.js?v=128',
  './modules/ly-routes.js?v=128',
  './modules/wx.js?v=128',
  './modules/logbook.js?v=128',
  './modules/logbook-push.js?v=128',
  './modules/gps.js?v=128',
  './modules/g.js?v=128',
  './modules/analytics.js?v=128',
  './modules/ical.js?v=128',
  './modules/calendar.js?v=128',
  './modules/proxy.js?v=128',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
