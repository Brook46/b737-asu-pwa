...
const CACHE_VERSION = 'flightcard-v102';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=102',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=102',
  './modules/dates.js?v=102',
  './modules/data-card.js?v=102',
  './modules/checklist.js?v=102',
  './modules/ui.js?v=102',
  './modules/ocr.js?v=102',
  './modules/speeches.js?v=102',
  './modules/airports.js?v=102',
  './modules/roster.js?v=102',
  './modules/ly-routes.js?v=102',
  './modules/wx.js?v=102',
  './modules/logbook.js?v=102',
  './modules/logbook-push.js?v=102',
  './modules/gps.js?v=102',
  './modules/g.js?v=102',
  './modules/analytics.js?v=102',
  './modules/ical.js?v=102',
  './modules/calendar.js?v=102',
  './modules/proxy.js?v=102',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
