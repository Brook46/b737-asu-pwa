...
const CACHE_VERSION = 'flightcard-v105';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=105',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=105',
  './modules/dates.js?v=105',
  './modules/data-card.js?v=105',
  './modules/checklist.js?v=105',
  './modules/print.js?v=105',
  './modules/ui.js?v=105',
  './modules/ocr.js?v=105',
  './modules/speeches.js?v=105',
  './modules/airports.js?v=105',
  './modules/roster.js?v=105',
  './modules/ly-routes.js?v=105',
  './modules/wx.js?v=105',
  './modules/logbook.js?v=105',
  './modules/logbook-push.js?v=105',
  './modules/gps.js?v=105',
  './modules/g.js?v=105',
  './modules/analytics.js?v=105',
  './modules/ical.js?v=105',
  './modules/calendar.js?v=105',
  './modules/proxy.js?v=105',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
