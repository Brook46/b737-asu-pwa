...
const CACHE_VERSION = 'flightcard-v130';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=130',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=130',
  './modules/dates.js?v=130',
  './modules/data-card.js?v=130',
  './modules/checklist.js?v=130',
  './modules/print.js?v=130',
  './modules/ui.js?v=130',
  './modules/ocr.js?v=130',
  './modules/speeches.js?v=130',
  './modules/airports.js?v=130',
  './modules/worldmap.js?v=130',
  './modules/roster.js?v=130',
  './modules/ly-routes.js?v=130',
  './modules/wx.js?v=130',
  './modules/logbook.js?v=130',
  './modules/logbook-push.js?v=130',
  './modules/gps.js?v=130',
  './modules/g.js?v=130',
  './modules/analytics.js?v=130',
  './modules/ical.js?v=130',
  './modules/calendar.js?v=130',
  './modules/proxy.js?v=130',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
