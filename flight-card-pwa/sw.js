...
const CACHE_VERSION = 'flightcard-v125';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=125',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=125',
  './modules/dates.js?v=125',
  './modules/data-card.js?v=125',
  './modules/checklist.js?v=125',
  './modules/print.js?v=125',
  './modules/ui.js?v=125',
  './modules/ocr.js?v=125',
  './modules/speeches.js?v=125',
  './modules/airports.js?v=125',
  './modules/worldmap.js?v=125',
  './modules/roster.js?v=125',
  './modules/ly-routes.js?v=125',
  './modules/wx.js?v=125',
  './modules/logbook.js?v=125',
  './modules/logbook-push.js?v=125',
  './modules/gps.js?v=125',
  './modules/g.js?v=125',
  './modules/analytics.js?v=125',
  './modules/ical.js?v=125',
  './modules/calendar.js?v=125',
  './modules/proxy.js?v=125',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
