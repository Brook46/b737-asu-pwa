...
const CACHE_VERSION = 'flightcard-v122';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=122',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=122',
  './modules/dates.js?v=122',
  './modules/data-card.js?v=122',
  './modules/checklist.js?v=122',
  './modules/print.js?v=122',
  './modules/ui.js?v=122',
  './modules/ocr.js?v=122',
  './modules/speeches.js?v=122',
  './modules/airports.js?v=122',
  './modules/worldmap.js?v=122',
  './modules/roster.js?v=122',
  './modules/ly-routes.js?v=122',
  './modules/wx.js?v=122',
  './modules/logbook.js?v=122',
  './modules/logbook-push.js?v=122',
  './modules/gps.js?v=122',
  './modules/g.js?v=122',
  './modules/analytics.js?v=122',
  './modules/ical.js?v=122',
  './modules/calendar.js?v=122',
  './modules/proxy.js?v=122',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
