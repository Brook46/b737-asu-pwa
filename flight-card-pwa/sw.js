...
const CACHE_VERSION = 'flightcard-v133';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=133',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=133',
  './modules/dates.js?v=133',
  './modules/data-card.js?v=133',
  './modules/checklist.js?v=133',
  './modules/print.js?v=133',
  './modules/ui.js?v=133',
  './modules/ocr.js?v=133',
  './modules/speeches.js?v=133',
  './modules/airports.js?v=133',
  './modules/worldmap.js?v=133',
  './modules/roster.js?v=133',
  './modules/ly-routes.js?v=133',
  './modules/wx.js?v=133',
  './modules/logbook.js?v=133',
  './modules/logbook-push.js?v=133',
  './modules/gps.js?v=133',
  './modules/g.js?v=133',
  './modules/analytics.js?v=133',
  './modules/sectors-csv.js?v=133',
  './modules/ical.js?v=133',
  './modules/calendar.js?v=133',
  './modules/proxy.js?v=133',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
