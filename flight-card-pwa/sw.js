...
const CACHE_VERSION = 'flightcard-v107';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=107',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=107',
  './modules/dates.js?v=107',
  './modules/data-card.js?v=107',
  './modules/checklist.js?v=107',
  './modules/print.js?v=107',
  './modules/ui.js?v=107',
  './modules/ocr.js?v=107',
  './modules/speeches.js?v=107',
  './modules/airports.js?v=107',
  './modules/roster.js?v=107',
  './modules/ly-routes.js?v=107',
  './modules/wx.js?v=107',
  './modules/logbook.js?v=107',
  './modules/logbook-push.js?v=107',
  './modules/gps.js?v=107',
  './modules/g.js?v=107',
  './modules/analytics.js?v=107',
  './modules/ical.js?v=107',
  './modules/calendar.js?v=107',
  './modules/proxy.js?v=107',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
