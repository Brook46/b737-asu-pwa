...
const CACHE_VERSION = 'flightcard-v131';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=131',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=131',
  './modules/dates.js?v=131',
  './modules/data-card.js?v=131',
  './modules/checklist.js?v=131',
  './modules/print.js?v=131',
  './modules/ui.js?v=131',
  './modules/ocr.js?v=131',
  './modules/speeches.js?v=131',
  './modules/airports.js?v=131',
  './modules/worldmap.js?v=131',
  './modules/roster.js?v=131',
  './modules/ly-routes.js?v=131',
  './modules/wx.js?v=131',
  './modules/logbook.js?v=131',
  './modules/logbook-push.js?v=131',
  './modules/gps.js?v=131',
  './modules/g.js?v=131',
  './modules/analytics.js?v=131',
  './modules/ical.js?v=131',
  './modules/calendar.js?v=131',
  './modules/proxy.js?v=131',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
