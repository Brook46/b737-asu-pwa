...
const CACHE_VERSION = 'flightcard-v136';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=136',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=136',
  './modules/dates.js?v=136',
  './modules/data-card.js?v=136',
  './modules/checklist.js?v=136',
  './modules/print.js?v=136',
  './modules/ui.js?v=136',
  './modules/ocr.js?v=136',
  './modules/speeches.js?v=136',
  './modules/airports.js?v=136',
  './modules/worldmap.js?v=136',
  './modules/roster.js?v=136',
  './modules/ly-routes.js?v=136',
  './modules/wx.js?v=136',
  './modules/logbook.js?v=136',
  './modules/logbook-push.js?v=136',
  './modules/gps.js?v=136',
  './modules/g.js?v=136',
  './modules/analytics.js?v=136',
  './modules/sectors-csv.js?v=136',
  './modules/ical.js?v=136',
  './modules/calendar.js?v=136',
  './modules/proxy.js?v=136',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
