...
const CACHE_VERSION = 'flightcard-v113';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=113',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=113',
  './modules/dates.js?v=113',
  './modules/data-card.js?v=113',
  './modules/checklist.js?v=113',
  './modules/print.js?v=113',
  './modules/ui.js?v=113',
  './modules/ocr.js?v=113',
  './modules/speeches.js?v=113',
  './modules/airports.js?v=113',
  './modules/roster.js?v=113',
  './modules/ly-routes.js?v=113',
  './modules/wx.js?v=113',
  './modules/logbook.js?v=113',
  './modules/logbook-push.js?v=113',
  './modules/gps.js?v=113',
  './modules/g.js?v=113',
  './modules/analytics.js?v=113',
  './modules/ical.js?v=113',
  './modules/calendar.js?v=113',
  './modules/proxy.js?v=113',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
