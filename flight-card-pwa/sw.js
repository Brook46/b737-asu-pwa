...
const CACHE_VERSION = 'flightcard-v132';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=132',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=132',
  './modules/dates.js?v=132',
  './modules/data-card.js?v=132',
  './modules/checklist.js?v=132',
  './modules/print.js?v=132',
  './modules/ui.js?v=132',
  './modules/ocr.js?v=132',
  './modules/speeches.js?v=132',
  './modules/airports.js?v=132',
  './modules/worldmap.js?v=132',
  './modules/roster.js?v=132',
  './modules/ly-routes.js?v=132',
  './modules/wx.js?v=132',
  './modules/logbook.js?v=132',
  './modules/logbook-push.js?v=132',
  './modules/gps.js?v=132',
  './modules/g.js?v=132',
  './modules/analytics.js?v=132',
  './modules/sectors-csv.js?v=132',
  './modules/ical.js?v=132',
  './modules/calendar.js?v=132',
  './modules/proxy.js?v=132',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
