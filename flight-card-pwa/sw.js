...
const CACHE_VERSION = 'flightcard-v106';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=106',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=106',
  './modules/dates.js?v=106',
  './modules/data-card.js?v=106',
  './modules/checklist.js?v=106',
  './modules/print.js?v=106',
  './modules/ui.js?v=106',
  './modules/ocr.js?v=106',
  './modules/speeches.js?v=106',
  './modules/airports.js?v=106',
  './modules/roster.js?v=106',
  './modules/ly-routes.js?v=106',
  './modules/wx.js?v=106',
  './modules/logbook.js?v=106',
  './modules/logbook-push.js?v=106',
  './modules/gps.js?v=106',
  './modules/g.js?v=106',
  './modules/analytics.js?v=106',
  './modules/ical.js?v=106',
  './modules/calendar.js?v=106',
  './modules/proxy.js?v=106',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
