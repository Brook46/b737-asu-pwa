...
const CACHE_VERSION = 'flightcard-v127';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=127',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=127',
  './modules/dates.js?v=127',
  './modules/data-card.js?v=127',
  './modules/checklist.js?v=127',
  './modules/print.js?v=127',
  './modules/ui.js?v=127',
  './modules/ocr.js?v=127',
  './modules/speeches.js?v=127',
  './modules/airports.js?v=127',
  './modules/worldmap.js?v=127',
  './modules/roster.js?v=127',
  './modules/ly-routes.js?v=127',
  './modules/wx.js?v=127',
  './modules/logbook.js?v=127',
  './modules/logbook-push.js?v=127',
  './modules/gps.js?v=127',
  './modules/g.js?v=127',
  './modules/analytics.js?v=127',
  './modules/ical.js?v=127',
  './modules/calendar.js?v=127',
  './modules/proxy.js?v=127',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
