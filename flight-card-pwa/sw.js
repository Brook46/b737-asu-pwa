...
const CACHE_VERSION = 'flightcard-v123';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=123',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=123',
  './modules/dates.js?v=123',
  './modules/data-card.js?v=123',
  './modules/checklist.js?v=123',
  './modules/print.js?v=123',
  './modules/ui.js?v=123',
  './modules/ocr.js?v=123',
  './modules/speeches.js?v=123',
  './modules/airports.js?v=123',
  './modules/worldmap.js?v=123',
  './modules/roster.js?v=123',
  './modules/ly-routes.js?v=123',
  './modules/wx.js?v=123',
  './modules/logbook.js?v=123',
  './modules/logbook-push.js?v=123',
  './modules/gps.js?v=123',
  './modules/g.js?v=123',
  './modules/analytics.js?v=123',
  './modules/ical.js?v=123',
  './modules/calendar.js?v=123',
  './modules/proxy.js?v=123',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
