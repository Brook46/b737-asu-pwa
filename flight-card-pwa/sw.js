...
const CACHE_VERSION = 'flightcard-v116';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=116',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=116',
  './modules/dates.js?v=116',
  './modules/data-card.js?v=116',
  './modules/checklist.js?v=116',
  './modules/print.js?v=116',
  './modules/ui.js?v=116',
  './modules/ocr.js?v=116',
  './modules/speeches.js?v=116',
  './modules/airports.js?v=116',
  './modules/roster.js?v=116',
  './modules/ly-routes.js?v=116',
  './modules/wx.js?v=116',
  './modules/logbook.js?v=116',
  './modules/logbook-push.js?v=116',
  './modules/gps.js?v=116',
  './modules/g.js?v=116',
  './modules/analytics.js?v=116',
  './modules/ical.js?v=116',
  './modules/calendar.js?v=116',
  './modules/proxy.js?v=116',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
