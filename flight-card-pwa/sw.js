...
const CACHE_VERSION = 'flightcard-v110';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=110',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=110',
  './modules/dates.js?v=110',
  './modules/data-card.js?v=110',
  './modules/checklist.js?v=110',
  './modules/print.js?v=110',
  './modules/ui.js?v=110',
  './modules/ocr.js?v=110',
  './modules/speeches.js?v=110',
  './modules/airports.js?v=110',
  './modules/roster.js?v=110',
  './modules/ly-routes.js?v=110',
  './modules/wx.js?v=110',
  './modules/logbook.js?v=110',
  './modules/logbook-push.js?v=110',
  './modules/gps.js?v=110',
  './modules/g.js?v=110',
  './modules/analytics.js?v=110',
  './modules/ical.js?v=110',
  './modules/calendar.js?v=110',
  './modules/proxy.js?v=110',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
