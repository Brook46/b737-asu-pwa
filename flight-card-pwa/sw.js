...
const CACHE_VERSION = 'flightcard-v121';
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=121',
  ...
  './menu.html',
  './share.html',
  './modules/storage.js?v=121',
  './modules/dates.js?v=121',
  './modules/data-card.js?v=121',
  './modules/checklist.js?v=121',
  './modules/print.js?v=121',
  './modules/ui.js?v=121',
  './modules/ocr.js?v=121',
  './modules/speeches.js?v=121',
  './modules/airports.js?v=121',
  './modules/worldmap.js?v=121',
  './modules/roster.js?v=121',
  './modules/ly-routes.js?v=121',
  './modules/wx.js?v=121',
  './modules/logbook.js?v=121',
  './modules/logbook-push.js?v=121',
  './modules/gps.js?v=121',
  './modules/g.js?v=121',
  './modules/analytics.js?v=121',
  './modules/ical.js?v=121',
  './modules/calendar.js?v=121',
  './modules/proxy.js?v=121',
  './share-roster.html',
  './icons/icon-152.png',
  './icons/icon-167.png',
  './icons/icon-180.png',
